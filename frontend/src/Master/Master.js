...
const Master = () => {
    ...
    const renderData = () => {
        if (emergencies.dataEmergencies && emergencies.dataEmergencies.length > 0) {
            return emergencies.dataEmergencies.map((Val, index) => (
            ...
            return <NoData title="Emergency" />;
        }
    };
    return (
        <>
            <div className="row">
                <div className="col-lg-3 col-md-4 col-sm-6 description">
                    <div className="center mt-3" >
                        <div className='col-lg-3 col-md-4 col-sm-6 logoMaster'>
                            <img src={require('./img/logo.png')} alt='Help Me/Emergency' />
                        </div>
                    </div>
                    <div className='col-lg-3 col-md-4 col-sm-6 descriptionParagraph'>
