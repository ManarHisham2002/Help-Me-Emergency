...
const Master = () => {
    ...
    return (
        <>
            <div className='row'>
                <div className='col-xl-3 col-lg-3 col-md-4 col-sm-12 col-12 leftSideMasterDescription'>
                ...
                <div className='col-xl-9 col-lg-9 col-md-8 col-sm-12 col-12 firstAid'>
                            ...
                            {emergencies.loading ? (
                                ...
                                emergencies.dataEmergencies && emergencies.dataEmergencies.length > 0 ? (
                                    emergencies.dataEmergencies.map((Val, index) => (
                                        <div className='article-card col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6' key={index}>
