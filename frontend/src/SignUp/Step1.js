    ...
    return (
        <section id='step-1'>
            ...
            <div className='input-div'>
                ...
                <FontAwesomeIcon icon={showPassword.password ? faEye : faEyeSlash} className='icon toggle-password-icon'
                    onClick={() => togglePasswordVisibility('password')} />
            </div>
            <div className='input-div'>
                <RiLockPasswordFill className='icon' />
                <input type={showPassword.confirmPassword ? 'text' : 'password'} placeholder='Confirm Password'
                    name='confirmPassword' onChange={(e) => setInfoUser({ ...infoUser, confirmPassword: e.target.value })} />
                <FontAwesomeIcon icon={showPassword.confirmPassword ? faEye : faEyeSlash} className='icon toggle-password-icon'
                ...
                <div className='row'>
                    <label className='col-6 labelRadio'>
                        <input type='radio' name='gender' value='male'
                            onChange={(e) => setInfoUser({ ...infoUser, gender: e.target.value })} />
                        <span>Male</span>
                    </label>
                    <label className='col-6 labelRadio'>
