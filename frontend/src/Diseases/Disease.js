    ...
    return (
        <>
            ...
            <div className='container-fluid'>
                <div className='row'>
                    <div className='col-lg-11 col-md-11 col-sm-11 diseasePage mt-5'>
                        <div className='disease'>
                            <div className='container text-center'>
                                {diseases.loading ? (
                                    ...
                                    <>
                                        <div className="row">
                                            <div className="col-lg-11 col-md-11 col-sm-11 searchField ">
                                                <input
                                                    type="text"
                                                    placeholder="Disease"
                                                    value={searchQuery}
                                        ...
                                        {dataToDisplay && dataToDisplay.length > 0 ? (
                                            <div className='row'>
                                                {dataToDisplay.slice(0, diseasesToShow).map((Val, index) => (
                                                    <div className='col-sm-6 col-md-4 col-lg-3 w-sm-auto' key={index}>
